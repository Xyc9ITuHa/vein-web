...
const Information = () => {
    ...
    return (
        // Replace your current section with this version:

        <section id="information" ref={root} className="py-16 relative border-t-2 border-light-oak/50 bg-cream -z-50 overflow-hidden">
            <div className="top-0 px-2 sm:px-4">
                <h1 className="font-black text-dark-bg text-4xl sm:text-6xl -z-50 top-3 mx-3 sm:mx-5">About Vein</h1>

                <div className="-z-30 h-fit bg-cream w-full pt-8 pb-12 phrase-container px-4 lg:px-16 xl:px-24">
                    <div className="mb-12 lg:mb-10 animated-border pb-10">
                        <p id="phrase" className="mb-6 text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-dark-bg tracking-tight">
                            Who We Are
                        </p>
                        <p id="whoText" className="text-dark-bg text-left max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed lg:leading-loose font-light">
                    ...
                    <div className="mb-12 lg:mb-10 animated-border pb-10">
                        ...
                        <p id="expText" className="text-dark-bg text-right max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed lg:leading-loose font-light ml-auto">
                    ...
                    <div className="mb-8 animated-border pb-10">
                        ...
                        <p id="philText" className="text-dark-bg text-center max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed lg:leading-loose font-light mx-auto">
            ...
            <div className="container mx-auto px-4 flex flex-col lg:flex-col xl:flex-row gap-8 lg:gap-12 items-start">
                <div className="flex-shrink-0 md:w-full lg:w-auto overflow-hidden">
                    <img
                        ref={flowersRef}
                        src={flowers}
                    ...
                    />
                    <h1 className="font-helvetica text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl text-dark-bg font-black leading-none relative z-10 break-words">
                        About<br />Alona
                    </h1>
                </div>

                <Card className="flex flex-col md:flex-row z-10 w-full">
                    <div className="flex-1 p-4 sm:p-6 md:p-8 flex items-center">
                    ...
                    <div className="flex-shrink-0 w-full sm:w-full md:w-80 lg:w-96">
                        <img
                            src={photo}
